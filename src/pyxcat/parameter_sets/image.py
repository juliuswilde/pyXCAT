...
class ImageParameters(BaseModel):
    ...
    atten_phan_each: bool = Field(default=True, alias="atten_phan_each", description="attenuation_coeff_phantom_each_frame (1=save phantom to file, 0=don't save)")
    ...
    atten_phan_ave: bool = Field(default=True, alias="atten_phan_ave", description="attenuation_coeff_phantom_average  (1=save, 0=don't save) see NOTE 1")
    act_phan_ave: bool = Field(default=True, alias="act_phan_ave", description="activity_phantom_average  (1=save, 0=don't save) see NOTE 1")
    ...
    subvoxel_index: int = Field(default=2, ge=1, le=4, alias="subvoxel_index", description="subvoxel_index (=1,2,3,4 -> 1,8,27,64 subvoxels/voxel, respectively)")
    startslice: int = Field(default=1, ge=1, alias="startslice", description="start slice")
    endslice: int = Field(default=128, ge=1, alias="endslice", description="end slice")
