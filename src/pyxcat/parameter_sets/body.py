...
class BodyParameters(BaseModel):
    ...
    organ_file: str = Field(default="vmale50.nrb", alias="organ_file", description="name of organ file that defines all organs (male = vmale50.nrb, female - vfemale50.nrb)")
    heart_base: str = Field(default="vmale50_heart.nrb", alias="heart_base", description="basename for heart files (male = vmale50_heart.nrb; female = vfemale50_heart.nrb)")
